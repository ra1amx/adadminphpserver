	...
	function submitform(){
		with(document.dati){
			...
			if (modulichecckati.value == ""){
				alert("Attenzione:\nl'inserimento di questa funzionalità non può essere\neffettuato perchè il componente a cui appartiene\nquesta funzionalità non è associato\na nessun modulo!\n\n")
				return
			}
			submit()
		}
